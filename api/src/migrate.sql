...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20260407181821_InitialSchema'
)
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[safehouses]') AND type = N'U')
BEGIN
...
BEGIN
    ...
    VALUES (N'20260407181821_InitialSchema', N'10.0.5');
END;
